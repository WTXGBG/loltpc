<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"C:\wamp\www\TPC-S\tp5 (1)\public/../application/reslog\view\register\register.html";i:1508770806;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
...
<script type="text/javascript">
  /*     $("#adminNo").blur(function()
    ...
    {
       $.post("<?php echo url('reslog/register/xxxx'); ?>", {yzm:$('input[name=yzm]').val()}, function(data){
             if(!data)
             {
                alert('验证码错误');
                $('input[name=yzm]').val('');
