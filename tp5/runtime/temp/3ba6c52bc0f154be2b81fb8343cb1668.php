<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"C:\wamp\www\TPC-S\tp5\public/../application/reslog\view\register\register.html";i:1508752852;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
                	...
                	<div class="part1">                	
                        <div class="item col-xs-12">
                            ...
                            <div class="f-fl item-ifo">
                                <input id="name" name="name" type="text" maxlength="20" class="txt03 f-r3 required" tabindex="1" data-valid="isNonEmpty||between:3-20
                        ...
                        <div class="item col-xs-12">
                            ...
                            <div class="f-fl item-ifo">
                                <input id="yzm" name="yzm" type="text" maxlength="4" class="txt03 f-r3 f-fl required" tabindex="4" style="width:167px" id="randCode" data-valid="isNonEmpty" data-error="验证码不能为空" /> 
                                <span class="ie8 icon-close close hide"></span>
                        ...
                        <div class="item col-xs-12">
                            <span class="intelligent-label f-fl">&nbsp;</span>    
                            <div class="f-fl item-ifo">
                               <a href="javascript:;" id="xyb1" class="btn btn-blue f-r3" id="btn_part1">下一步</a>                         
                            </div>
                        </div> 
                    </div>
...
<script type="text/javascript">
    ...
    $("#xyb1").click(function()
    {
       $.post("<?php echo url('reslog/register/register'); ?>", {yzm:$('input[name=yzm]').val()}, function(data){
             if(!data)
             {
                alert('验证码错误,请先修改');
             }
